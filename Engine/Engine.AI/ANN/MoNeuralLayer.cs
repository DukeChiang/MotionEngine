...
namespace MotionEngine.AI
{
	...
	public class MoNeuralLayer
	{
		...
		/// 神经元集合
		/// </summary>
		public readonly List<MoNeuron> Neurons = new List<MoNeuron>();
		...
		public MoNeuralLayer(int neurons, int inputs, ENeuralLayerType layerType)
		{
			LayerType = layerType;
			...
			{
				MoNeuron neuron = new MoNeuron(inputs);
				Neurons.Add(neuron);
			}
		}
...
#else
			return (1.0f / (1.0f + MathF.Exp(-value * Threshold)));
#endif
		}
...
#else
			return (MathF.Tan(value * Threshold));
#endif
		}
...
#else
			return ((2.0f / (1.0f + MathF.Exp(-value * Threshold))) - 1.0f);
#endif
		}
